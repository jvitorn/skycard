...
export function SkyCardFront({
  ...
  return (
    <section className="skycard-face p-[7%]" aria-label={profile.displayName}>
      <div className="relative z-10 flex h-full flex-col">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="font-sport text-[clamp(3rem,18vw,5.8rem)] font-black leading-[0.78] tracking-normal text-[var(--ovr)]">
              {scores.overall}
            </div>
        ...
        <div className="mt-auto flex flex-col items-center text-center">
          <SkyCardAvatar
            ...
            className="size-[28%] min-h-20 min-w-20"
          />
          <h2 className="mt-4 max-w-full truncate px-2 font-heading text-[clamp(1.35rem,7vw,2rem)] font-black leading-none">
            {profile.displayName}
          </h2>
        ...
        <CardAttributes scores={scores} className="mt-5" />
